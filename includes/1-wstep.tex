...
Temat wydajności protokołów sieci VPN jest obiektem wielu prac badawczych. Głównym celem, większości tych prac, jest porównanie syntetycznej wydajności osiąganej przez te protokoły, poprzez pomiary wykonywane w laboratoryjnych warunkach. \cite{S7ZE,JP59,CH57,E2K5}\\
