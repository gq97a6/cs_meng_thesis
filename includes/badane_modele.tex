...
Cały ruch sieciowy jest przekierowywany przez centralny serwer. Nawet gdy oba urządzenia fizycznie znajdują się blisko siebie, przesył danych dalej odbywa się z wykorzystaniem serwera jako pośrednika.\\
...
Dla pewnych zastosowań, brak centralizacji staje się minusem. Włączanie nowych klientów do sieci jest utrudnione. Nie ma również centralnej kontroli nad działaniem poszczególnych węzłów.\\