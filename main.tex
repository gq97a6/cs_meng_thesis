...
\DeclareBibliographyDriver{misc}{%Required comment for some reason
  \small
  Autor:~\texttransparent{0.6}{\printnames{author}}
  Rok:~\texttransparent{0.6}{\printdate}
  Tytuł:~\texttransparent{0.6}{\printfield{title}}
  Link:~\texttransparent{0.6}{\printfield{url}}
}
...
\include{includes/tytulowa}
\newpage

\include{includes/karta}
\newpage
...
\include{includes/wstep}
\newpage

\include{includes/slownik_pojec}
\newpage

\include{includes/restrykcyjne_srodowisko}
\newpage

\include{includes/badane_modele}
\newpage

\include{includes/badane_protokoly}
\newpage

\include{includes/metodologia_badan}
\newpage

\include{includes/konfiguracja_srodowiska}
\newpage

\include{includes/analiza_wynikow}
\newpage

\include{includes/ankieta}
\newpage

\include{includes/podsumowanie}
\newpage

\include{includes/bibliografia}
\newpage

\include{includes/zalaczniki}
\newpage


\end{document}  % --------------------------------------------------------------------

% git add .; git commit -m "No commit message."; git push origin master;