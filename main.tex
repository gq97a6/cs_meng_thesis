...
\include{includes/1-wstep}
\newpage

\include{includes/2-slownik_pojec}
\newpage

\include{includes/3-restrykcyjne_srodowisko}
\newpage

\include{includes/4-badane_modele}
\newpage

\include{includes/5-badane_protokoly}
\newpage

\include{includes/6-metodologia_badan}
\newpage

\include{includes/7-konfiguracja_srodowiska}
\newpage

\include{includes/8-analiza_wynikow}
\newpage

\include{includes/9-podsumowanie}
\newpage

\include{includes/10-bibliografia}
\newpage

\include{includes/11-zalaczniki}
\newpage
