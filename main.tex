...
\include{includes/3-charakterystyka_architektur}
\newpage

\include{includes/4-metodologia_badan}
\newpage

\include{includes/5-wyniki_pomiarow}
\newpage

\include{includes/6-interpretacja_wynikow}
\newpage

\include{includes/7-wnioski}
\newpage

\include{includes/8-bibliografia}
\newpage

\include{includes/9-zalaczniki}
\newpage
